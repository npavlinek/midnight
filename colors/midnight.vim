...
" License:      Unlicense
" Last Updated: 17 Sep 2022 13:46:31
...
hi DiffAdd guifg=#0c0c0c guibg=#33ff33 gui=NONE cterm=NONE
hi DiffChange guifg=#0c0c0c guibg=#ffd633 gui=NONE cterm=NONE
hi DiffDelete guifg=#0c0c0c guibg=#ff544e gui=NONE cterm=NONE
hi DiffText guifg=#0c0c0c guibg=#ff8581 gui=NONE cterm=NONE
hi Error guifg=#0c0c0c guibg=#ff544e gui=NONE cterm=NONE
hi FoldColumn guifg=#a0a0a0 guibg=#0c0c0c gui=bold cterm=bold
hi Folded guifg=#a0a0a0 guibg=#0c0c0c gui=NONE cterm=NONE
hi Identifier guifg=#cccccc guibg=#0c0c0c gui=NONE cterm=NONE
hi LineNr guifg=#a0a0a0 guibg=#0c0c0c gui=NONE cterm=NONE
...
hi SignColumn guifg=#a0a0a0 guibg=#0c0c0c gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi DiffAdd ctermfg=232 ctermbg=46 cterm=NONE
  hi DiffChange ctermfg=232 ctermbg=220 cterm=NONE
  hi DiffDelete ctermfg=232 ctermbg=203 cterm=NONE
  hi DiffText ctermfg=232 ctermbg=210 cterm=NONE
  hi Error ctermfg=232 ctermbg=203 cterm=NONE
  hi FoldColumn ctermfg=247 ctermbg=232 cterm=bold
  hi Folded ctermfg=247 ctermbg=232 cterm=NONE
  hi Identifier ctermfg=252 ctermbg=232 cterm=NONE
  hi LineNr ctermfg=247 ctermbg=232 cterm=NONE
  ...
  hi SignColumn ctermfg=247 ctermbg=232 cterm=bold
